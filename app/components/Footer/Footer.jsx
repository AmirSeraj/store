...
const Footer = () => {
    return (
        <footer className='bg-gray-800 text-white p-4 mt-auto 2xl:px-[18%] xl:px-[13%] sm:px-[8%] px-[5%]'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center mt-6 sm:gap-1 gap-5'>
